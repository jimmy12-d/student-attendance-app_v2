  ...
  const getGradeDependentStyles = (grade: string) => {
    switch (grade) {
        case 'A': return {
            ...
            gradeBadge: 'bg-green-500/30 text-green-700 dark:text-green-200 border-green-500/50',
        ...
        case 'B': return {
            ...
            gradeBadge: 'bg-emerald-500/30 text-emerald-700 dark:text-emerald-200 border-emerald-500/50',
        ...
        case 'C': return {
            ...
            gradeBadge: 'bg-sky-500/30 text-sky-700 dark:text-sky-200 border-sky-500/50',
        ...
        case 'D': return {
            ...
            gradeBadge: 'bg-yellow-500/30 text-yellow-700 dark:text-yellow-200 border-yellow-500/50',
        ...
        case 'E': return {
            ...
            glow2: 'bg-red-500/20',
            gradeBadge: 'bg-orange-500/30 text-orange-700 dark:text-orange-200 border-orange-500/50',
        ...
        case 'F': return {
            ...
            gradeBadge: 'bg-red-500/30 text-red-700 dark:text-red-200 border-red-500/50',
        ...
        default: return {
            ...
            gradeBadge: 'bg-slate-600/30 text-slate-700 dark:text-slate-200 border-slate-500/50',
                  ...
                  <>
                    <motion.div
                      className={`
                        ...
                        dark:from-slate-900 dark:via-slate-900/90 dark:to-black/80
                        p-6
                      ...
                      whileTap={{ scale: 0.92 }}
                    >
                        <div className="absolute top-0 left-0 w-1/2 h-1/2 rounded-full filter blur-3xl opacity-20 dark:opacity-30" style={{ background: gradeStyles.glow1 }}></div>
                        <div className="absolute bottom-0 right-0 w-1/2 h-1/2 rounded-full filter blur-3xl opacity-20 dark:opacity-30" style={{ background: gradeStyles.glow2 }}></div>

                        <div className="relative z-10 flex flex-col items-center">
                            {/* Student Name */}
                            {studentName && (
                              <div className="mb-4 text-center">
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-1 tracking-wide">
                                  {studentName}
                                </h3>
                                <div className="w-12 h-0.5 bg-gray-400/50 dark:bg-white/50 mx-auto rounded-full"></div>
                              </div>
                            )}
                        ...
                        if (examSettings.hasOwnProperty(subjectKey)) {
                          ...
                          return (
                            <ScoreCard
                              ...
                              grade={calculateGrade(score !== undefined ? score : 0, examSettings[subjectKey]?.maxScore || 0)}
                            />
                          );
                        }
                        return null;
